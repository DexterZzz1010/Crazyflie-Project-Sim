...
class quadrotor_controller_setpoint():
    def __init__(self):
        ...
        # KF Gains
        gains = {"P_vel_z": 6.0,     "I_vel_z": 0.5,     "D_vel_z": 0.8,
            "P_pos_z": 2.5,     "I_pos_z": 0.0,     "D_pos_z": 1.0,
            "P_rate_rp": 0.26,     "I_rate_rp":0.0,      "D_rate_rp": 0.03,
            "P_rate_y": 0.01,      "I_rate_y": 0.0,      "D_rate_y": 0.001,
            "P_att": 12.0,      "I_att": 0.0,      "D_att": 0.2,
            "P_vel_xy": 4.0,     "I_vel_xy": 0.3,     "D_vel_xy": 0.80,
            "P_pos_xy": 2.5,     "I_pos_xy": 0.0,     "D_pos_xy": 0.5}
