...
#include "crazyflie_interfaces/msg/detail/pose_velocity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const crazyflie_interfaces::msg::PoseVelocity & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  crazyflie_interfaces::msg::PoseVelocity & ros_message)
{
  // Member: position
  {
    cdr >> ros_message.position;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crazyflie_interfaces::msg::PoseVelocity;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const crazyflie_interfaces::msg::PoseVelocity *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crazyflie_interfaces::msg::PoseVelocity *>(
    untyped_ros_message);
...
{
  return &crazyflie_interfaces::msg::typesupport_fastrtps_cpp::_PoseVelocity__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crazyflie_interfaces, msg, PoseVelocity)() {
  return &crazyflie_interfaces::msg::typesupport_fastrtps_cpp::_PoseVelocity__handle;
}
